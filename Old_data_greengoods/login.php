...
// // cheda hu code ko login.php tha
//     exit;
// }
 
// Include config coonecting database connection  file
                    ...
                    if($result = mysqli_stmt_fetch($stmt)){
                        ...
                        // if(password_verify($password,$password )){
                           ...
                           echo $_SESSION["password"];
                            // Redirect user to welco me page
                           // header("location: welcome.php");
                        // } else{
...
<div id="main" style="margin:8%; Display:flex">

   <div>
     <img src="https://www.multishops.uk/wp-content/uploads/2020/05/MultishopsUK-Logo-Retina.png">
